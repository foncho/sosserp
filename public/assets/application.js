...
(function() {
  $(function() {
    var $realInputField, refreshCostCalculations, setPartialCostsAmount, setTotalCostAmount, showPaymentDate;
    ...
    showPaymentDate = function(value) {
      if ((value !== "") && (value === "Pagada")) {
        return $("#payment-date").show();
      } else {
        return $("#payment-date").hide();
      }
    };
    refreshCostCalculations = function(item) {
      var partial, quantity, tax, unit_cost;
      ...
      return setTotalCostAmount($(".tc"));
    };
    setPartialCostsAmount = function(q, uc, t, tag) {
      var result, subtotal, tax, tax_calculation;
      console.log(uc + " :: " + q + " :: " + t);
      tax = 0;
      if (t !== "") {
        tax = t.split(";")[1] / 100;
      ...
      return tag.val(result.toFixed(2));
    };
    setTotalCostAmount = function(objs) {
      var final, result;
      result = 0;
      objs.each(function() {
        return result += parseFloat($(this).val());
      });
      final = result;
      return $("#total").val(final.toFixed(2));
    };
    showPaymentDate = function(value) {
      if ((value !== "") && (value === "Pagada")) {
        return $(".payment-date").show();
    ...
    $(document).on("change", "#number", function(e) {
      return refreshCostCalculations($(this));
    });
    $(document).on("change", "#unit-cost", function(e) {
      return refreshCostCalculations($(this));
    });
    $(document).on("change", "#tax_id", function(e) {
      return refreshCostCalculations($(this));
    });
    return $(".tc").each(function() {
      return refreshCostCalculations($(this));
    });
  });
...
(function() {
  $(function() {
    var discounts, refreshCalculations, setPartialAmount, setTotalAmount;
    discounts = [
      {
        "discount": {
          "client_id": 1,
    ...
    refreshCalculations = function(item) {
      var discount, partial, product, quantity;
      ...
      return setTotalAmount($(".t"), $("#tax1").val(), $("#tax2").val());
    };
    setPartialAmount = function(q, p, d, tag) {
      var discount, result, subtotal, up;
      console.log(p + " :: " + q);
      up = 0;
      discount = 0;
      result = 0;
    ...
    setTotalAmount = function(objs, t1, t2) {
      var final, irpf, irpf_calculation, result, tax, tax_calculation;
      console.log(t1 + ' :: ' + t2);
      result = 0;
      tax = 0;
      irpf = 0;
    ...
    $('#clients').autocomplete({
      ...
      select: function(e, ui) {
        ...
        for (_i = 0, _len = discounts.length; _i < _len; _i++) {
          d = discounts[_i];
          if (d.discount.client_id === ui.item.id) {
            dis = d.discount.value;
          }
        }
        console.log(dis);
        $('#discount').val(dis);
        return $('.t').each(function() {
          return refreshCalculations(this);
        });
      }
    });
    ...
    $(document).on("change", "#tax1", function(e) {
      return setTotalAmount($(".t"), $("#tax1").val(), $("#tax2").val());
    });
    $(document).on("change", "#tax2", function(e) {
      return setTotalAmount($(".t"), $("#tax1").val(), $("#tax2").val());
    });
    return $(".t").each(function() {
      return refreshCalculations($(this));
...
(function() {
  $(function() {
    $("table > tbody > tr > td > a#example").on("click", function(e) {
...
(function() {
  $(function() {
    $("#user_role").on("change", function(e) {
      ...
      v = $(this).val();
      if (v === "delegate") {
        return $(".user_zone").slideDown(300);
      } else {
        return $(".user_zone").slideUp(300);
      }
    });
    $("#new_pass").on("change", function(e) {
      if ($(this).val() !== "") {
        return $(".user_current_pass").slideDown(300);
      } else {
        return $(".user_current_pass").slideUp(300);
      }
    });
    $(".zones").autocomplete({
      source: "/zones",
    ...
    return $("#bank_account_account_number").on("change", function(e) {
      var accountNumber, an0, an1, an2, an3, an4, an5, an6, an7, an8, an9, b0, b1, b2, b3, branch, cd, controlDigit, digit1, digit2, ec0, ec1, ec2, ec3, entityCode, resto1, resto2, sum1, sum2;
      ...
      if (entityCode !== "") {
        ec0 = parseInt(entityCode.split("")[0]);
      }
      if (entityCode !== "") {
        ec1 = parseInt(entityCode.split("")[1]);
      }
      if (entityCode !== "") {
        ec2 = parseInt(entityCode.split("")[2]);
      }
      if (entityCode !== "") {
        ec3 = parseInt(entityCode.split("")[3]);
      }
      console.log(ec0 + ' :: ' + ec1 + ' :: ' + ec2 + ' :: ' + ec3);
      if (branch !== "") {
        b0 = parseInt(branch.split("")[0]);
      }
      if (branch !== "") {
        b1 = parseInt(branch.split("")[1]);
      }
      if (branch !== "") {
        b2 = parseInt(branch.split("")[2]);
      }
      if (branch !== "") {
        b3 = parseInt(branch.split("")[3]);
      }
      console.log(b0 + ' :: ' + b1 + ' :: ' + b2 + ' :: ' + b3);
      if (accountNumber !== "") {
        an0 = parseInt(accountNumber.split("")[0]);
      }
      if (accountNumber !== "") {
        an1 = parseInt(accountNumber.split("")[1]);
      }
      if (accountNumber !== "") {
        an2 = parseInt(accountNumber.split("")[2]);
      }
      if (accountNumber !== "") {
        an3 = parseInt(accountNumber.split("")[3]);
      }
      if (accountNumber !== "") {
        an4 = parseInt(accountNumber.split("")[4]);
      }
      if (accountNumber !== "") {
        an5 = parseInt(accountNumber.split("")[5]);
      }
      if (accountNumber !== "") {
        an6 = parseInt(accountNumber.split("")[6]);
      }
      if (accountNumber !== "") {
        an7 = parseInt(accountNumber.split("")[7]);
      }
      if (accountNumber !== "") {
        an8 = parseInt(accountNumber.split("")[8]);
      }
      if (accountNumber !== "") {
        an9 = parseInt(accountNumber.split("")[9]);
      }
      ...
      console.log(cd);
      if (controlDigit !== cd) {
        return alert("El dígito control es incorrecto. Por favor, revíse el número de cuenta antes de salvar.");
      }
    });
  });
